...
namespace MusicShopAPI.Controllers
{
    public class AlbumsController : ApiController
    {
        ...
        // GET: api/Albums
        //[Route("api/ici/Albums")]
        public IQueryable<Album> GetAlbums()
        {
            db.Genres.ToList();
            List<AlbumAPI> listAlbumAPI = new List<AlbumAPI>();

            foreach ( Album album in db.Albums.ToList())
            {
                listAlbumAPI.Add(new AlbumAPI(album));
            }

            return listAlbumAPI.AsQueryable() ;
        }
